...
void SilentSysmon(HANDLE hProc)
{
	HANDLE hThread = NULL;
...
void go(char *args, int len)
{
	...
	if (pid)
	{
		...
		{
			BeaconPrintf(CALLBACK_ERROR, "Failed to open a handle to the Sysmon process!\n");
		}
	}
	else 
	{
		BeaconPrintf(CALLBACK_ERROR, "Please specify the correct process ID of the Sysmon service!\n");
	}
}
} // end extern "C"
